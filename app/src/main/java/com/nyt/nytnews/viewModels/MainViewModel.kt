...
/**
 * This is viewmodel class for the topstories
...
class MainViewModel(private val mainRepository: MainRepository, private val context: Context) :
    ...
    /**
     * Function  To get NYT stories from API
     */
    ...
    /**
     * Callback Function Executed when user de-selects an article from Bookmarked fragment
     */
    ...
    /**
     * Function ReSubmits the loaded list to visualize the bookmark button ui changes on articles which have been de-Bookmarked by user
     */
