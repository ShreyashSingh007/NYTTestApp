...
/**
 * This is detailed fragment page which appears upon clicking any item from top stories list
...
class DetailedFragment : Fragment() {
    ...
    /**
     * This function tries to Load the image from url on failing sets default image
    ...
    /**
     * Function to redirect users to original news article
     */
